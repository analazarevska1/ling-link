...
@section('content')
    ...
    {{-- RECOMMENDATION --}}
    <div class="flex flex-col items-center text-center py-12 md:py-16 mt-16 md:mt-0" style="background: #f8fbff;">
        <p class="text-base md:text-lg text-gray-700 mb-6 px-6" style="font-family: 'Montserrat', sans-serif;">
        ...
        <form method="POST" action="/set-personalizacija-session">
            ...
            <button type="submit"
                ...
                style="width: 185px; height: 50px; border-radius: 20px; background: #194077; color: white; font-family: 'Montserrat', sans-serif; font-size: 14px; box-shadow: 0px 0px 7px 0px rgba(0,0,0,0.10);"
