    ...
    <div class="w-full px-4 md:px-20 py-10">
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="flex-1 bg-white rounded-3xl p-8 shadow-2xl">
                ...
                <p class="text-gray-500 text-sm mb-6">Пополнете ја формата и некој од нашиот тим ќе ве контактира во најкус
                    можен рок.</p>
                ...
                <form method="POST" action="{{ route('prijava.store', 'контакт') }}">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 mb-4">
                        <div class="flex-1">
                            ...
                            <input type="text" name='name' placeholder="пр.Маја Иванова"
                        ...
                        <div class="flex-1">
                            ...
                            <input type="text" name='phone' placeholder="пр.07* *** ***"
                                class="w-full border border-gray-300 rounded-full px-4 py-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-900">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name='email' placeholder="пр. majaivanova@gmail.com"
                            class="w-full border border-gray-300 rounded-full px-4 py-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-900">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea rows="7" name="message" placeholder='пр. "Сакам да се пријавам за активно и пасивно."'
            ...
            <div class="flex-1 rounded-3xl p-8 text-white" style="background-color: #194077;">
                ...
                <p class="text-blue-200 text-sm mb-8">Слободно обратете ни се за сите прашања, информации или соработка.
                    Тука сме да ви помогнеме.</p>
                ...
                <div class="flex items-start gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <a href="http://www.lingualink.com.mk/"
                            class="text-blue-300 text-sm hover:underline">http://www.lingualink.com.mk/</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        ...
                        {{-- Instagram --}}
                        <a href="#" class="bg-white rounded-full p-3 hover:bg-blue-100 transition">
                            <svg class="w-5 h-5" style="color: #194077;" fill="none" stroke="currentColor"
